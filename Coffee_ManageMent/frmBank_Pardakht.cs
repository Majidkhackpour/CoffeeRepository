...
{
    public partial class frmBank_Pardakht : Form
    {
        SqlConnection dataconnection = new SqlConnection(clsFunction.Connection_string);
        public string op, Bank_Code, Type, Loan_Code, Loan_Date;
        int Doc_Number;
        ...
        public void Fill_Data(int ID)
        {
            ...
            try
            {
                SqlDataAdapter da2 = new SqlDataAdapter("SELECT Code1, Code2, Babat_Code, Fish_Number FROM tbl_Pay_Recive_Info WHERE ID='" + ID.ToString() + "'", dataconnection);
                ...
                txtFish_Number.Text = dt2.Rows[0].ItemArray[3].ToString();
            }
            catch
            {
            }
        ...
        private void Delete_Data(int ID)
        {
            try
            {
                string query1 = "DELETE FROM tbl_Transaction WHERE Parent=8 AND Parent_Code='" + ID.ToString() + "'";
        ...
        private void Insertasion()
        {
            ...
            {
                Get_Max_Doc_Number();
                string query1 = "INSERT INTO tbl_Transaction (Code, Bestankar, Notice, Date, Time, Doc_Number, Moeen, Parent, Parent_Code) VALUES ('" + Bank_Code + "','" + Convert.ToInt64(txtCash.Text) + "',N'" + "پرداخت طی فیش " + txtFish_Number.Text + " " + "به " + txtName.Text + " " + "بابت " + txtBabat_Name.Text + "','" + txtDate.Text + "','" + lblTime.Text + "','" + Doc_Number + "','" + "10101" + "',8,'" + lblID.Text + "')";
                string query2 = "INSERT INTO tbl_Transaction (Code, Bedehkar, Notice, Date, Time, Doc_Number, Moeen, Parent, Parent_Code) VALUES ('" + txtTafsili.Text + "','" + Convert.ToInt64(txtCash.Text) + "',N'" + "دریافت طی فیش " + txtFish_Number.Text + " " + "بابت " + txtBabat_Name.Text + "','" + txtDate.Text + "','" + lblTime.Text + "','" + Doc_Number + "','" + txtMoeen_Code.Text + "',8,'" + lblID.Text + "')";
                string query3 = "INSERT INTO tbl_Pay_Recive_Info (ID, Code1, Code2, Babat_Code, Fish_Number) VALUES ('" + lblID.Text + "','" + txtCode.Text + "','" + txtTafsili.Text + "','" + txtBabat_Code.Text + "','" + txtFish_Number.Text + "')";
        ...
        public frmBank_Pardakht()
        {
            InitializeComponent();
        }

        private void frmBank_Pardakht_Load(object sender, EventArgs e)
        {
        ...
        {
            if (e.KeyValue == 13)
                txtFish_Number.Focus();
        }

        private void txtFish_Number_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyValue == 13)
                txtCode.Focus();
            else if (e.KeyData == Keys.F12)
            {
                ...
                txtFish_Number.Text = rand.Next(100000, 999999).ToString();
            }
        }
        ...
        private void txtFish_Number_KeyPress(object sender, KeyPressEventArgs e)
        {
