...
{
    public partial class frmBank_Daryaft : Form
    {
        SqlConnection dataconnection = new SqlConnection(clsFunction.Connection_string);
        public string op, Bank_Code;
        int Doc_Number;
        ...
        private void Delete_Data(int ID)
        {
            try
            {
                string query1 = "DELETE FROM tbl_Transaction WHERE Parent=7 AND Parent_Code='" + ID.ToString() + "'";
        ...
        private void Insertasion()
        {
            ...
            {
                Get_Max_Doc_Number();
                string query1 = "INSERT INTO tbl_Transaction (Code, Bedehkar, Notice, Date, Time, Doc_Number, Moeen, Parent, Parent_Code) VALUES ('" + Bank_Code + "','" + Convert.ToInt64(txtCash.Text) + "',N'" + "دریافت طی فیش " + txtFish_Number.Text + " " + "از " + txtName.Text + " " + "بابت " + txtBabat_Name.Text + "','" + txtDate.Text + "','" + lblTime.Text + "','" + Doc_Number + "','" + "10101" + "',7,'" + lblID.Text + "')";
                string query2 = "INSERT INTO tbl_Transaction (Code, Bestankar, Notice, Date, Time, Doc_Number, Moeen, Parent, Parent_Code) VALUES ('" + txtTafsili.Text + "','" + Convert.ToInt64(txtCash.Text) + "',N'" + "پرداخت طی فیش " + txtFish_Number.Text + " " + "بابت " + txtBabat_Name.Text + "','" + txtDate.Text + "','" + lblTime.Text + "','" + Doc_Number + "','" + txtMoeen_Code.Text + "',7,'" + lblID.Text + "')";
        ...
        public frmBank_Daryaft()
        {
            InitializeComponent();
        }

        private void frmBank_Daryaft_Load(object sender, EventArgs e)
        {
