...
{
    public partial class frmBuy_Factor : Form
    {
        ...
        private void Document()
        {
            try
            {
                ...
                {
                    string q = "INSERT INTO tbl_Transaction (Bedehkar, Notice, Doc_Number, Moeen, Parent, Parent_Code) VALUES ('" + Convert.ToInt64(txtTotal.Text) + "',N'" + "حساب های پرداختنی" + "','" + 1 + "','" + 302 + "','" + 0 + "','" + 1 + "')";
                    if (clsFunction.Execute(dataconnection, q) == true)
                    {
                    }
                }
        ...
        public void Form_Load()
        {
            ...
            string query2 = "SELECT MAX (ID) FROM tbl_Header_Buy_Factor";
        ...
        {
            Form_Load();
            SqlDataAdapter da = new SqlDataAdapter("SELECT Date, Reciver, Sett_Date, Bill, Seller_Code, Price, Discount, Added_Value, Total, Register, Doc_Code, Notice FROM tbl_Header_Buy_Factor WHERE ID= '" + ID + "'", dataconnection);
            DataTable dt = new DataTable();
            da.Fill(dt);
            ...
            chbRegister.Checked = Convert.ToBoolean(dt.Rows[0].ItemArray[9]);
            Ware_Rec_ID_Edit = Convert.ToInt64(dt.Rows[0].ItemArray[10]);
            txtNotice.Text = dt.Rows[0].ItemArray[11].ToString();
            SqlDataAdapter da2 = new SqlDataAdapter("SELECT tbl_Body_Buy_Factor.P_Code, tbl_Product.P_Show_Name, tbl_Body_Buy_Factor.Entity, tbl_Unit.Unit_Name, tbl_Body_Buy_Factor.P_Cost, tbl_Body_Buy_Factor.Total FROM tbl_Body_Buy_Factor INNER JOIN tbl_Product ON tbl_Body_Buy_Factor.P_Code = tbl_Product.P_Code INNER JOIN tbl_Unit ON tbl_Product.Unit = tbl_Unit.Unit_Code WHERE tbl_Body_Buy_Factor.ID='" + ID + "'", dataconnection);
        ...
        private void Get_Max_WareHouse_Reciept_ID()
        {
            try
            {
                SqlDataAdapter da = new SqlDataAdapter("SELECT MAX (ID) FROM tbl_Header_WareReceipt", dataconnection);
                DataTable dt = new DataTable();
                da.Fill(dt);
        ...
        public void Delete_Data(int ID)
        {
            try
            {
                string query1 = "DELETE FROM tbl_Body_Buy_Factor WHERE ID = '" + ID + "'";
                string query2 = "DELETE FROM tbl_Body_WareReceipt WHERE ID = '" + Ware_Rec_ID_Edit + "'";
                string query3 = "DELETE FROM tbl_Tour_Of_Product WHERE Parent=2 AND Parent_Code = '" + Ware_Rec_ID_Edit + "'";
                string query4 = "DELETE FROM tbl_Transaction WHERE Parent=2 AND Parent_Code = '" + ID + "'";
        ...
        public void FillData_Order(int ID)
        {
            Form_Load();
            SqlDataAdapter da = new SqlDataAdapter("SELECT Seller_Code, Date FROM tbl_Header_Buy_Order WHERE ID= '" + ID + "'", dataconnection);
            DataTable dt = new DataTable();
            da.Fill(dt);
            txtCode.Text = dt.Rows[0].ItemArray[0].ToString();
            txtDate.Text = dt.Rows[0].ItemArray[1].ToString();
            SqlDataAdapter da2 = new SqlDataAdapter("SELECT tbl_Body_Buy_Order.P_Code, tbl_Product.P_Show_Name, tbl_Body_Buy_Order.Entity, tbl_Unit.Unit_Name FROM tbl_Body_Buy_Order INNER JOIN tbl_Product ON tbl_Body_Buy_Order.P_Code = tbl_Product.P_Code INNER JOIN tbl_Unit ON tbl_Product.Unit = tbl_Unit.Unit_Code WHERE tbl_Body_Buy_Order.ID='" + ID + "'", dataconnection);
            DataTable dt2 = new DataTable();
            da2.Fill(dt2);
            dgvStore.DataSource = dt2;
            Calculate_All();
        ...
        public frmBuy_Factor()
        {
            InitializeComponent();
        }

        private void frmBuy_Factor_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (d1 > d2)
                    {
                        frmMessage f = new frmMessage();
                        f.flag = 0;
                        f.lblMessage.Text = "تاریخ فاکتور خرید نمی تواند از تاریخ روز بزرگتر باشد";
                        f.ShowDialog();
                    }
                    else
                    {
                        if (op == "Add")
                        {
                            ...
                            query1 = "INSERT INTO tbl_Header_Buy_Factor (ID, Date, Reciver, Store, Sett_Date, Bill, Seller_Code, Price, Discount, Added_Value, Total, Register, UserName, Doc_Code, Notice) VALUES ('" + Convert.ToInt64(txtID.Text) + "','" + txtDate.Text + "',N'" + txtDelivery.Text + "','" + Store_Code + "','" + txtSett_Date.Text + "',N'" + txtBill.Text + "','" + txtCode.Text + "','" + Convert.ToInt64(txtCost.Text) + "','" + Convert.ToInt64(txtDiscount_Price.Text) + "','" + Convert.ToInt64(txtAdded_Price.Text) + "','" + Convert.ToInt64(txtTotal.Text) + "','" + Convert.ToBoolean(chbRegister.Checked) + "','" + clsFunction.User_Real_Name + "','" + Ware_Rec_ID + "',N'" + txtNotice.Text + "')";
                            query2 = "INSERT INTO tbl_Header_WareReceipt (ID, Code, Date, Delivery, Bill, Notice, Type, Store, Validation) VALUES ('" + Ware_Rec_ID + "','" + txtCode.Text + "','" + txtDate.Text + "',N'" + txtDelivery.Text + "',N'" + txtBill.Text + "',N'" + "فاکتور خرید به شماره " + txtID.Text + " " + "مورخ " + txtDate.Text + " " + "توضیحات: " + txtNotice.Text + "',2,'" + Store_Code + "','" + "خیر" + "')";
                            if (clsFunction.Execute(dataconnection, query2) == true && clsFunction.Execute(dataconnection, query1) == true)
                            {
                                for (int i = 0; i < dgvStore.Rows.Count ; i++)
                                {
                                    try
                                    {
                                        query5 = "INSERT INTO tbl_Body_Buy_Factor (ID, P_Code, Entity, P_Cost, Total) VALUES ('" + Convert.ToInt64(txtID.Text) + "','" + Convert.ToInt32(dgvStore.Rows[i].Cells["Code"].Value) + "','" + float.Parse(dgvStore.Rows[i].Cells["Entity"].Value.ToString()) + "','" + Convert.ToInt64(dgvStore.Rows[i].Cells["Buy_Price"].Value) + "','" + Convert.ToInt64(dgvStore.Rows[i].Cells["Cost"].Value) + "')";
                                        query3 = "INSERT INTO tbl_Tour_Of_Product (P_Code, Date, Origin, Incoming, Notice, Parent, Parent_Code, Store) VALUES ('" + Convert.ToInt32(dgvStore.Rows[i].Cells["Code"].Value) + "','" + txtDate.Text + "','" + txtName.Text + "','" + float.Parse(dgvStore.Rows[i].Cells["Entity"].Value.ToString()) + "',N'" + "فاکتور خرید به شماره " + txtID.Text + " " + "مورخ " + txtDate.Text + " " + "توضیحات: " + txtNotice.Text + "',2,'" + Convert.ToInt32(Ware_Rec_ID) + "','" + Store_Code + "')";
                                        query4 = "INSERT INTO tbl_Body_WareReceipt (ID, P_Code, Entity) VALUES ('" + Ware_Rec_ID + "','" + Convert.ToInt32(dgvStore.Rows[i].Cells["Code"].Value) + "','" + float.Parse(dgvStore.Rows[i].Cells["Entity"].Value.ToString()) + "')";
                                ...
                                {
                                    Get_Max_Reminder_ID();
                                    query7 = "INSERT INTO tbl_Reminder (ID, Title, Body, Ins_Date, Remind_Date) VALUES ('" + Reminder_ID + "',N'" + "تسویه با بستانکاران تجاری" + "',N'" + "تسویه با " + txtName.Text + " " + "بابت فاکتور خرید شماره " + " " + txtID.Text + " " + "مورخ " + txtDate.Text + "','" + clsFunction.M2SH(DateTime.Now) + "','" + txtSett_Date.Text + "')";
                                ...
                                if (chbRegister.Checked)
                                {
                                    ...
                                    Get_Max_Doc_Number();
                                    query8 = "INSERT INTO tbl_Transaction (Bedehkar, Notice, Date, Time, Doc_Number, Moeen, Parent, Parent_Code) VALUES ('" + Convert.ToInt64(txtCost.Text) + "',N'" + "فاکتور خرید به شماره " + txtID.Text + " " + "مورخ " + txtDate.Text + " " + "توضیحات: " + txtNotice.Text + "','" + txtDate.Text + "','" + System.DateTime.Now.ToLongTimeString() + "','" + Doc_Number + "','" + "70103" + "','" + 2 + "','" + txtID.Text + "')";
                                    query9 = "INSERT INTO tbl_Transaction (Code, Bedehkar, Bestankar, Notice, Date, Time, Doc_Number, Moeen, Parent, Parent_Code) VALUES ('" + txtCode.Text + "','" + 0 + "','" + Convert.ToInt64(Cost_Discount) + "',N'" + "فاکتور خرید به شماره " + txtID.Text + " " + "مورخ " + txtDate.Text + " " + "توضیحات: " + txtNotice.Text + "','" + txtDate.Text + "','" + System.DateTime.Now.ToLongTimeString() + "','" + Doc_Number + "','" + "30201" + "','" + 2 + "','" + txtID.Text + "')";
                        ...
                        else if (op == "Edit")
                        {
                            ...
                            query1 = "UPDATE tbl_Header_Buy_Factor SET Date = '" + txtDate.Text + "', Reciver = N'" + txtDelivery.Text + "', Store = '" + Store_Code + "', Sett_Date = '" + txtSett_Date.Text + "', Bill = N'" + txtBill.Text + "', Seller_Code = '" + txtCode.Text + "', Price = '" + Convert.ToInt64(txtCost.Text) + "', Discount = '" + Convert.ToInt64(txtDiscount_Price.Text) + "', Added_Value = '" + Convert.ToInt64(txtAdded_Price.Text) + "', Total = '" + Convert.ToInt64(txtTotal.Text) + "',  Register = '" + Convert.ToBoolean(chbRegister.Checked) + "', Notice = N'" + txtNotice.Text + "' WHERE ID = '" + Convert.ToInt64(txtID.Text) + "'";
                            query2 = "UPDATE tbl_Header_WareReceipt SET Code = '" + txtCode.Text + "', Date = '" + txtDate.Text + "', Delivery = N'" + txtDelivery.Text + "', Bill = N'" + txtBill.Text + "', Notice = N'" + txtNotice.Text + "', Store='" + Store_Code + "' WHERE ID = '" + Ware_Rec_ID_Edit + "'";
                            if (clsFunction.Execute(dataconnection, query2) == true && clsFunction.Execute(dataconnection, query1) == true)
                            {
                                for (int i = 0; i < dgvStore.Rows.Count; i++)
                                {
                                    ...
                                    {
                                        query5 = "INSERT INTO tbl_Body_Buy_Factor (ID, P_Code, Entity, P_Cost, Total) VALUES ('" + Convert.ToInt64(txtID.Text) + "','" + Convert.ToInt32(dgvStore.Rows[i].Cells["Code"].Value) + "','" + float.Parse(dgvStore.Rows[i].Cells["Entity"].Value.ToString()) + "','" + Convert.ToInt64(dgvStore.Rows[i].Cells["Buy_Price"].Value) + "','" + Convert.ToInt64(dgvStore.Rows[i].Cells["Cost"].Value) + "')";
                                        query3 = "INSERT INTO tbl_Tour_Of_Product (P_Code, Date, Origin, Incoming, Notice, Parent, Parent_Code, Store) VALUES ('" + Convert.ToInt32(dgvStore.Rows[i].Cells["Code"].Value) + "','" + txtDate.Text + "','" + txtName.Text + "','" + float.Parse(dgvStore.Rows[i].Cells["Entity"].Value.ToString()) + "',N'" + "فاکتور خرید به شماره " + txtID.Text + " " + "مورخ " + txtDate.Text + " " + "توضیحات: " + txtNotice.Text + "',2,'" + Convert.ToInt32(Ware_Rec_ID_Edit) + "','" + Store_Code + "')";
                                        query4 = "INSERT INTO tbl_Body_WareReceipt (ID, P_Code, Entity) VALUES ('" + Ware_Rec_ID_Edit + "','" + Convert.ToInt32(dgvStore.Rows[i].Cells["Code"].Value) + "','" + float.Parse(dgvStore.Rows[i].Cells["Entity"].Value.ToString()) + "')";
                                        query6 = "UPDATE tbl_Product SET Store = '" + Store_Code + "', Buy_Price = '" + Convert.ToInt64(dgvStore.Rows[i].Cells["Buy_Price"].Value) + "' WHERE P_Code = '" + Convert.ToInt32(dgvStore.Rows[i].Cells["Code"].Value) + "'";
                                        if (clsFunction.Execute(dataconnection, query5) == true && clsFunction.Execute(dataconnection, query4) == true)
                                        {
                                            if (clsFunction.Execute(dataconnection, query3) == true && clsFunction.Execute(dataconnection, query6) == true)
        ...
        private void chbRegister_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyValue == 13)
                btnFinish.Focus();
        }
