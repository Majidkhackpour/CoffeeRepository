...
{
    public partial class frmCash_Daryaft : Form
    {
        ...
        private void Delete_Data(int ID)
        {
            try
            {
                string query1 = "DELETE FROM tbl_Transaction WHERE Parent=5 AND Parent_Code='" + ID.ToString() + "'";
        ...
        private void Insertasion()
        {
            ...
            {
                Get_Max_Doc_Number();
                string query1 = "INSERT INTO tbl_Transaction (Code, Bedehkar, Notice, Date, Time, Doc_Number, Moeen, Parent, Parent_Code) VALUES ('" + Safe_Code + "','" + Convert.ToInt64(txtCash.Text) + "',N'" + "دریافت وجه نقد از " + txtName.Text + " " + "بابت " + txtBabat_Name.Text + "','" + txtDate.Text + "','" + lblTime.Text + "','" + Doc_Number + "','" + "10102" + "',5,'" + lblID.Text + "')";
                string query2 = "INSERT INTO tbl_Transaction (Code, Bestankar, Notice, Date, Time, Doc_Number, Moeen, Parent, Parent_Code) VALUES ('" + txtTafsili.Text + "','" + Convert.ToInt64(txtCash.Text) + "',N'" + "پرداخت وجه نقد بابت " + txtBabat_Name.Text + "','" + txtDate.Text + "','" + lblTime.Text + "','" + Doc_Number + "','" + txtMoeen_Code.Text + "',5,'" + lblID.Text + "')";
        ...
        public frmCash_Daryaft()
        {
            InitializeComponent();
        }

        private void frmCash_Daryaft_Load(object sender, EventArgs e)
        {
